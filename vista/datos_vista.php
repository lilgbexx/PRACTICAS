        ...
        ?>    
            <table id="customers">                 
                ...
                ?>
                        ...
                        <input type='hidden' id='direccionD" . $id . "' value=" . $direccion2 . " autocomplete='on'>
                        <input type='hidden' id='telefonoD" . $id . "' value=" . $telefono2 . " autocomplete='on'> 
                        <button type='button' style='background-color: #c0cd00;color: white;  height:60px ; width:175px;font-size:30px' onclick='modificar(" . $id . ")'> Modificar </button>
                                </td>";
                              ?>
                         </form>
            <?php
            ...
            ?>
            <div id="container" class="editar"></div>
...
<div id="footer">
  ...
  <img src="images/logo.png" alt="Tu foto" id="imagenelogo">
    <h1 id="h1footer">DERECHOS RESERVADOS © 2023 </h1>
  <img src="images/logo.png" alt="Tu foto" id="imagenelogo">

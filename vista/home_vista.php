  ...
  <div class="site-navbar-wrap">
    ...
    <div class="site-navbar site-navbar-target js-sticky-header">
      <div class="container">
        <div class="row align-items-center">
          <div class="col-2">
            <h1 class="my-0 site-logo"><a href="home.html">$GSCOMPANY$</a></h1>
          </div>
          <div class="col-10">
                ...
                <ul class="site-menu main-menu js-clone-nav d-none d-lg-block">
                  ...
                  <li class="has-children">
                    ...
                    <ul class="dropdown arrow-top">
                      ...
                      <li><a href="#" class="nav-link">FORMULARY</a></li>
                      <li><a href="" class="nav-link">LOCATE US</a></li>
 

                    </ul>
                  </li>
                  <li><a href="login.html" class="nav-link">MY ACCOUNT</a></li>
                  <li><a href="#gallery-section" class="nav-link">CART</a></li>

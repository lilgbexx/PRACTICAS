<?php
// front controler para acceder a la informacion de diversas tablas
...
define ('CONTROLLERS_FOLDER', "controlador/");//Controlador define es una constante (nombre de la constante, valor de la constante)
//Si no se indica un controlador, este es el controlador que se usará por defecto
define ('DEFAULT_CONTROLLER', "shop"); //productos
